...
- Pârametros de busca (Search Params / Query Params) `http://localhost:3333/users?name=Gabriel`
- Pârametros de rota (Route Params) -> Identificação de recursos `DELETE http://localhost:3333/users/5`
...
<img src="./assets/erd.svg" width="600" alt="Diagrama ERD do banco de dados" />
